  ...
  render() {
    return (
      <div id="about" className="section">
        ...
        <p>
          My first concept was called iOS Fuji and can be found <a href="https://eugenekevin.github.io/" target="_blank" rel="noopener noreferrer">here</a>. A few months later, I published <a href="https://eugenekevindesign.github.io/" target="_blank" rel="noopener noreferrer">iOS Fuji 2.0</a> which aimed at simplifying the initial concept.
        </p>
        <p>
